...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D_ZZajnb.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-C3xWbEFR.css";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: "Document Ghost Swamp" },
			{
				name: "description",
				content: "A walk through Louisiana folklore, cryptids, and bayou creatures. Collect, read, and wander until dark."
			}
		],
		links: [{
			rel: "stylesheet",
...
var $$splitComponentImporter = () => import("./routes-BnqQN9fK.mjs");
